...
public class Ventana extends JFrame {
    ...
    private void nombreTFMousePressed(java.awt.event.MouseEvent evt) {                                      
        nombreTF.setText("");
        nombreTF.setForeground(Color.black);
    }                                     

    private void matriculaTFMousePressed(java.awt.event.MouseEvent evt) {                                     
        matriculaTF.setText("");
        matriculaTF.setForeground(Color.black);
    }                                    

    private void carreraTFMousePressed(java.awt.event.MouseEvent evt) {                                            
        carreraTF.setText("");
        carreraTF.setForeground(Color.black);
    }                                           

    private void correoTFMousePressed(java.awt.event.MouseEvent evt) {                                       
        correoTF.setText("");
        correoTF.setForeground(Color.black);
    }                                      
    ...
    private void agregarEstudianteMouseClicked(java.awt.event.MouseEvent evt) {                                                
        if(!"".equals(nombreTF.getText()) && !"".equals(matriculaTF.getText()) && !"".equals(carreraTF.getText()) && !"".equals(correoTF.getText())){
            Estudiante es = new Estudiante(this.nombreTF.getText(),this.matriculaTF.getText(),this.carreraTF.getText(),this.correoTF.getText());
            getArrayList().add(es);
        ...
        private void eliminarEstudianteMouseClicked(java.awt.event.MouseEvent evt) {                                                
        if(!"".equals(nombreTF.getText()) && !"".equals(matriculaTF.getText()) && !"".equals(carreraTF.getText()) && !"".equals(correoTF.getText())){
            Estudiante es = new Estudiante(this.nombreTF.getText(),this.matriculaTF.getText(),this.carreraTF.getText(),this.correoTF.getText());
            getArrayList().remove(es);
...
//            JOptionPane.showMessageDialog(null, "No se encontro");
        ...
        Estudiante e = new Estudiante("Fernanda Jara","20679273620","ICII","f.jatra09@ufromail.cl");
        estudiante.add(e);
        public ArrayList<Estudiante> getArrayList(){
        return estudiante;
